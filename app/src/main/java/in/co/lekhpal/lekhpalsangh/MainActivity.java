    ...
    public void displayView(int viewId) {
        ...
        switch (viewId) {
            case R.id.nav_home:
                ...
                viewIsAtHome = true;
                break;
            case R.id.nav_lekhpal:
                fragment = new LekhpalFragment();
                title = getString(R.string.lekhpal_title);
                viewIsAtHome = false;
                break;
            case R.id.nav_edistrict:
                fragment = new eDistrictFragment();
                title = getString(R.string.lekhpal_edistrict);
                viewIsAtHome = false;
                break;
           /* case R.id.nav_news:
                fragment = new NewsFragment();
                title = getString(R.string.lekhpal_news);
                viewIsAtHome = false;
                break;*/
